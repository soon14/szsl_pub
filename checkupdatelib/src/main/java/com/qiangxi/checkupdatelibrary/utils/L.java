...
public class L {
    /**
     * tag标签可通过#CheckUpdate.debug(String tag, boolean debug)方法设置
     *
     * @param msg log信息
     */
    public static void e(String msg) {
        if (CheckUpdate.isDebug) Log.e(CheckUpdate.TAG_NAME, msg);
    }
    ...
    public static void e(Throwable t) {
        if (t == null || !CheckUpdate.isDebug) return;
        ...
        Log.e(CheckUpdate.TAG_NAME, sb.toString());
    }

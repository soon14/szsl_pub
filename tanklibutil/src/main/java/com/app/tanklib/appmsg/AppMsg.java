...
package com.app.tanklib.appmsg;
...
public class AppMsg {
     ...
     */
    public static final Style STYLE_ALERT = new Style(LENGTH_LONG, R.color.appmsg_alert);

    /**
     * Show the text notification for a short period of time with a positive style.
     */
    public static final Style STYLE_CONFIRM = new Style(LENGTH_SHORT, R.color.appmsg_confirm);

    /**
     * Show the text notification for a short period of time with a neutral style.
     */
    public static final Style STYLE_INFO = new Style(LENGTH_SHORT, R.color.appmsg_info);

...
import com.app.tanklib.view.IndicatorFragmentActivity.TabInfo;
...
//    private static final int FOOTER_COLOR = 0xFFFFC445;
  private static final int FOOTER_COLOR = 0xFF00AC8B;
    ...
    public TitleIndicator(Context context, AttributeSet attrs) {
        ...
        int footerColor = a.getColor(R.styleable.TitleIndicator_footerColor1, FOOTER_COLOR);
        ...
        mFooterLineHeight = a.getDimension(R.styleable.TitleIndicator_footerLineHeight1,
                FOOTER_LINE_HEIGHT);

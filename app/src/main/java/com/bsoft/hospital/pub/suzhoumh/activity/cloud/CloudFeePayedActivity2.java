 ...
 */
public class CloudFeePayedActivity2 extends BaseActivity {
    ...
    private class GetDataTask extends
        ...
        protected ResultModel<ArrayList<PayedGroupVo>> doInBackground(
                Void... params) {
            return HttpApi.getInstance().parserArray(PayedGroupVo.class, "auth/remote/cloudClinic/getClinicPayedList",

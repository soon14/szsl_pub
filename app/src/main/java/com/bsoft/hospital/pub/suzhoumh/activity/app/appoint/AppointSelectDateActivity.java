 ...
 */
public class AppointSelectDateActivity extends BaseActivity implements OnClickListener {
    ...
    public AppointSelectDateActivity() {
    ...
    private void initData() {
        ...
        if (type == 1) {
            doctor = (AppointDoctorVo) getIntent().getSerializableExtra("doctor");//从专家那边传过来
    ...
    private void enterNextMonth(int gvFlag) {
        ...
        calV = new CalendarAdapter(this, this.getResources(), jumpMonth, jumpYear, year_c, month_c, day_c, dataList);
    ...
    private void addGridView() {
        ...
        gridView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                return AppointSelectDateActivity.this.gestureDetector.onTouchEvent(event);
            }
        });
        ...
        gridView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (dataList.contains(strShowDate)) {
                    ...
                    Intent intent = new Intent(baseContext, AppointTimeActivity.class);
    ...
    private void setListener() {
        ...
        calV = new CalendarAdapter(this, getResources(), jumpMonth, jumpYear, year_c, month_c, day_c, dataList);
        addGridView();
        gridView.setAdapter(calV);
            ...
            if (null != result) {
                if (result.statue == Statue.SUCCESS) {
                    if (null != result.list && result.list.size() > 0) {
                        ...
                        Toast.makeText(baseContext, "当前医生无排班", Toast.LENGTH_SHORT)
                                .show();
                    }
                } else {

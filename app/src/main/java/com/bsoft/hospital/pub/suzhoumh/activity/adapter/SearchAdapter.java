...
public class SearchAdapter extends BaseAdapter {
	...
	public SearchAdapter(Activity baseActivity) {
		dataList = new ArrayList<ChoiceItem>();
	...
	public void add(ArrayList<ChoiceItem> result) {
		if (null != result) {
			this.dataList = result;
		} else {
			this.dataList = new ArrayList<ChoiceItem>();
		}
		notifyDataSetChanged();
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mLayoutInflater.inflate(R.layout.dic_item, null);
		...
		viewholder.ibCheck.setVisibility(View.GONE);
		return convertView;
	}

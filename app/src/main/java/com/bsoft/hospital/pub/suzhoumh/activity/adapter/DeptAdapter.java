...
public class DeptAdapter extends BaseAdapter {
	...
	private List<DeptModelVo> dataList = new ArrayList<DeptModelVo>();

	public DeptAdapter(Context baseActivity) {
		this.mLayoutInflater = (LayoutInflater) baseActivity
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
	}

	public void addData(List<DeptModelVo> msgs) {
		if (null != msgs) {
			dataList = msgs;
		} else {
			dataList = new ArrayList<DeptModelVo>();
		}
		notifyDataSetChanged();
	}

	public void addMoreData(List<DeptModelVo> msgs) {
		if (null != msgs) {
	...
	@Override
	public DeptModelVo getItem(int position) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		DeptModelVo item = dataList.get(position);

...
import com.bsoft.hospital.pub.suzhoumh.picker.adapter.WheelAdapter;
import com.bsoft.hospital.pub.suzhoumh.picker.listener.OnItemSelectedListener;
...
public class WheelView extends View {
    ...
    private static final float CENTERCONTENTOFFSET = 4;//中间文字垂直居中需要此偏移值
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        textColorOut = ContextCompat.getColor(context, R.color.text_tips);
        textColorCenter = ContextCompat.getColor(context, R.color.main);
        dividerColor = ContextCompat.getColor(context, R.color.stroke);
        //配合customTextSize使用，customTextSize为true才会发挥效果
        textSize = SizeUtils.sp2px(16);
        customTextSize = true;
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.picker, 0, 0);
            mGravity = a.getInt(R.styleable.picker_picker_gravity, Gravity.CENTER);
            textColorOut = a.getColor(R.styleable.picker_textColorOut, textColorOut);
            textColorCenter = a.getColor(R.styleable.picker_textColorCenter, textColorCenter);
            dividerColor = a.getColor(R.styleable.picker_dividerColor, dividerColor);
            textSize = a.getDimensionPixelOffset(R.styleable.picker_textSize, textSize);
            a.recycle();
        }
...
//        canvas.drawLine(0.0F, secondLineY, measuredWidth, secondLineY, paintIndicator);
        canvas.drawLine(measuredWidth / 8, firstLineY, measuredWidth * 7 / 8, firstLineY, paintIndicator);
        canvas.drawLine(measuredWidth / 8, secondLineY, measuredWidth * 7 / 8, secondLineY, paintIndicator);

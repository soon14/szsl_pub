...
public class SelectProfileOrAppointActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appoint_profile_select);
        initView();
        findView();
        initData();
        setListener();
    ...
    private void initData() {
        ...
        fragsList.add(new AppointDetailFragment());

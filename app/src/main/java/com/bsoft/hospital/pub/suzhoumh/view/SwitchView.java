...
public class SwitchView extends LinearLayout implements OnClickListener {
	...
	public void setSwitchText(String text,String text2){
		switch_text_true.setText(text);
		switch_text_false.setText(text2);
	}
	...
	private void changeTextColor() {
		if(isChecked) {
			...
			switch_text_false.setTextColor(context.getResources().getColor(R.color.black));
		} else {
			switch_text_true.setTextColor(context.getResources().getColor(R.color.black));

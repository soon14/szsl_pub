...
public class RouteDetailAdapter extends BaseAdapter {
	...
	public RouteDetailAdapter(Context baseActivity) {
		this.mLayoutInflater = (LayoutInflater) baseActivity
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
	}

	public void addData(List<String> msgs) {
		if (null != msgs) {
			dataList = msgs;
		} else {
	...
	public void addMoreData(List<String> msgs) {
		if (null != msgs) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mLayoutInflater.inflate(R.layout.seek_routeitem, null);

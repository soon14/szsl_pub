...
public class CloudFeeDetailActivity extends BaseActivity {
    ...
    public void findView() {
        ...
        btn_pay.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CloudFeeDetailActivity.this, FeePayActivity.class);
...
//			return HttpNewApi.getInstance().parserData_His(FeeDetailVo.class, "clinicPay/getClinicPayDetails", map);
            return HttpApi.getInstance().parserArray(FeeDetailVo.class, "auth/remote/cloudClinic/getClinicPayListDetail", new BsoftNameValuePair("sbxh", feeVo.sbxh), new BsoftNameValuePair("cfyj", feeVo.cfyj));

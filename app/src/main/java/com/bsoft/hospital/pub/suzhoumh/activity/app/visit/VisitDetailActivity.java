...
public class VisitDetailActivity extends BaseActivity{
    ...
    public void findView() {
        ...
        expandableListView = (ExpandableListView)findViewById(R.id.ex_detail);
        expandableListView.setGroupIndicator(null);
    }

    private void initData()
    {
        visitVo = (VisitVo)getIntent().getSerializableExtra("visitVo");
    ...
    class MyAdapter extends BaseExpandableListAdapter {
        ...
        public View getChildView(int groupPosition, int childPosition,
            ...
            if(convertView == null)
            {
                ...
                convertView = LayoutInflater.from(baseContext).inflate(R.layout.item_visit_detail_child,null);
        ...
        public View getGroupView(int groupPosition, boolean isExpanded,
            ...
            if(convertView == null)
            {
                ...
                convertView = LayoutInflater.from(baseContext).inflate(R.layout.item_visit_detail,null);
